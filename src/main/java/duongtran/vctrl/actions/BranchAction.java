...
public class BranchAction {
     ...
     */
    public void execute(String branchName) throws IOException {
        Refs ref = new Refs();
        RefHead refHead = ref.getRefHead();

        // Get curren head value
        String currentBranchHeadValue = ref.readHead();
        ...
        refHead.updateBranchHeadValue(branchHead, currentBranchHeadValue);
