...
class CommitTest {
    ...
    @Test
    void testCommitWithMultipleParents() throws Exception {
        Instant time = Instant.ofEpochSecond(1716030000);
        CommitAuthor author = new CommitAuthor(
                "Alice",
                "alice@example.com",
        ...
        ObjectID treeId = new ObjectID("0123456789abcdef0123456789abcdef01234567");
        List<ObjectID> parentIds = new ArrayList<>(List.of(
                new ObjectID("abcdefabcdefabcdefabcdefabcdefabcdefabcd")
                , new ObjectID("abcdefabcdexxbcdefabcdefabcdefabcdefabcd")
        ));
        String message = "Initial commit";
